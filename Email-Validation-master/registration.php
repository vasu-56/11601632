	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form action="#" method="POST" class="login100-form validate-form" role="form"> 
					<span class="login100-form-title p-b-59">
						Sign Up
					</span>

					<div class="wrap-input100 validate-input" data-validate="Name is required">
						<span for="name1" class="label-input100">Full Name</span>
						<input class="input100" type="text" id="name1" name="name1" placeholder="Name...">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<span class="label-input100">Email</span>
						<input class="input100" type="text" id="email1" name="email1" placeholder="Email addess...">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Username is required">
						<span class="label-input100">Username</span>
						<input class="input100" type="text" id="username1" name="username1" placeholder="Username...">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<span class="label-input100">Password</span>
						<input class="input100" type="password" id="pass1" name="pass1" placeholder="*************">
						<span class="focus-input100"></span>
					</div>
...
<?php
	...
	$status=0;
	$activationcode=md5($b.time());
	
	$sql1="INSERT INTO  userregistration(`fullname`,`username`,`email`,`passcode`,`activationcode`,`statuss`)values('$a','$c','$b','$d','$activationcode','$status')";
	...
	if($sql1)
	{
            ...
            window.location.href="/assignment/display.php";
			</script>
			<?php
